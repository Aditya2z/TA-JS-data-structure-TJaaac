...
for(let i = 0; i < got.houses[1].people.length; i++) {
  console.log(`I am ${got.houses[1].people[i].name} and` +
   `my bio is ${got.houses[1].people[i].description}`);
  }
...
for(let i = 0; i < got.houses[0].people.length; i++) {
  console.log(`I am ${got.houses[0].people[i].name} and` +
   `my bio is ${got.houses[0].people[i].description}`);
  }

// 9. Log the name and description of the people in house Starks whose name is `Robb Stark`
for(let i = 0; i < got.houses[0].people.length; i++) {
  if(`Robb Stark` == got.houses[0].people[i].name) {
    console.log(`I am ${got.houses[0].people[i].name} and` +
    `my bio is ${got.houses[0].people[i].description}`);
  }
  }
...
for(let i = 0; i < got.houses[1].people.length; i++) {
  if(`Tywin Lannister` == got.houses[1].people[i].name) {
    console.log(`I am ${got.houses[1].people[i].name} and` +
    `my bio is ${got.houses[1].people[i].description}`);
  }
  }
...
let obj = {Starks: got.houses[0].people.length,
