...
console.log(person2.firstName); // output 'Arya'// Copy by refrence
console.log(person.firstName); // output 'Arya' //Changed directly
...
console.log(person === personTwo); // output false
console.log(person.address === personTwo.address); // output true // Shallow Cloning
console.log(person.address == personTwo.address); // output true // Shallow Cloning
...
console.log(personTwo.firstName); // output output 'John' //Cloning
console.log(person.firstName); // output 'Arya'
console.log(personTwo.lastName); // output 'Doe'
console.log(person.firstName === personTwo.firstName); // output false
console.log(person == personTwo); // output false
console.log(person === personTwo); // output false
console.log(person.address === personTwo.address); // output false //Deep Cloning
console.log(person.address == personTwo.address); // output false // Deep Cloning
console.log(personTwo.address.city); // output 'San Jose'
console.log(person.address.city); // output 'San Jose'
console.log(person.address.city == personTwo.address.city); // output true // Both containing same value
```
...
5. Clone the `questions` variable into a new variable named `questionClone`
...
let clonedPerson = [...person]; // first layer of cloning
// Your code goes here 
```
